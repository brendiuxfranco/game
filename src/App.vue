<template>
  <v-app>
    <v-app-bar app clipped-left dark color="green">
      <v-toolbar-title>P-Pong-Game</v-toolbar-title>
    </v-app-bar>
    <v-navigation-drawer app clipped class="orange ligthten-1">
      <v-list-item>
        <v-list-item-content>
          <v-spacer />
      ...
      <v-list-item>
        <v-btn block color="gray" @click="$router.go(0)">Restart</v-btn>
      </v-list-item>
    </v-navigation-drawer>
